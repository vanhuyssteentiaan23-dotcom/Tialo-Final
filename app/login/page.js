 ...
 async function submit(e){
  ...
  try{
   ...
   if(trusted){
    ...
    setSent(true);setHandoff(false);setMessage('Sign-in link sent. Open it on this computer and TIALO will take you straight into your workspace.')
    return
   }
