    ...
    <main className="shell dashboard-shell">
      ...
      <section className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          <section className="stat-grid"><article className="stat-card"><span>Subjects</span><strong>{subjects.length}</strong><small>Added to your workspace</small></article><article className="stat-card"><span>Daily tasks</span><strong>0</strong><small>Your plan will appear here</small></article><article className="stat-card"><span>Mock exams</span><strong>0</strong><small>Your completed exams</small></article><article className="stat-card"><span>Study streak</span><strong>0</strong><small>Days in a row</small></article></section>
